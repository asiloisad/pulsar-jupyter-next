...
class JupyterNotebookEditor {
  ...
  getPath() {
    return this.document ? this.document.filePath : null
  }
  ...
  // We return false to match TextEditor behavior - unsaved content is serialized
  // and restored on next session rather than prompting user to save.
  shouldPromptToSave() {
    return false
  }
