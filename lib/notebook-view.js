...
class NotebookView {
  ...
  buildToolbar() {
    ...
    toolbarLeft.appendChild(
      this.createCommandButton("hydrogen-next:run-cell", "icon-playback-play", "Run Cell"),
    );
    toolbarLeft.appendChild(
    ...
    toolbarLeft.appendChild(
      this.createCommandButton("hydrogen-next:run-all", "icon-list-unordered", "Run All Cells"),
    );
    ...
    toolbarLeft.appendChild(
      this.createCommandButton("hydrogen-next:restart-kernel", "icon-sync", "Restart Kernel"),
    );
    toolbarLeft.appendChild(
      this.createCommandButton(
    ...
    this._tooltips.add(
      atom.tooltips.add(insertAboveBtn, {
        ...
        keyBindingCommand: "jupyter-next:insert-cell-above",
      }),
    );
    ...
    this._tooltips.add(
      atom.tooltips.add(insertBelowBtn, {
        ...
        keyBindingCommand: "jupyter-next:insert-cell-below",
      }),
    );
    ...
    this._tooltips.add(
      atom.tooltips.add(moveUpBtn, {
        title: "Move Cell Up",
        keyBindingCommand: "jupyter-next:move-cell-up",
      }),
    );
    ...
    this._tooltips.add(
      atom.tooltips.add(moveDownBtn, {
        ...
        keyBindingCommand: "jupyter-next:move-cell-down",
      }),
    );
    ...
    this._tooltips.add(
      atom.tooltips.add(clearAllOutputsBtn, {
        ...
        keyBindingCommand: "jupyter-next:clear-all-outputs",
      }),
    );
  ...
  scrollToCursor(index, editor) {
    ...
    // Mirror Pulsar's getVerticalAutoscrollMargin() logic
    const containerHeight = this.cellsContainer.clientHeight;
