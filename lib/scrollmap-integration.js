...
class NotebookScrollmap {
  constructor(editor, Simplemap) {
    ...
    this.disposables.add(
      ...
      atom.config.onDidChange("jupyter-next.maxInputHeight", () => this.scheduleUpdate()),
      atom.config.onDidChange("jupyter-next.maxOutputHeight", () => this.scheduleUpdate()),
      atom.config.onDidChange("jupyter-next.scrollOutput", () => this.scheduleUpdate()),
